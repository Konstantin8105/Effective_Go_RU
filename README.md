...
* [Данные](#Данные)
	...
	* [Массивы](#Массивы)
	* [Срезы(Slices, слайсы)](#Срезы(Slices,-слайсы))
	* [Двухмерные срезы](#Двухмерные-срезы)
	* [Карты(Maps)](#Карты(Maps))
	* [Печать(Printing)](#Печать(Printing))
	* [Присоединение(Append)](#Присоединение(Append))
* [Инициализация(Initialization)](#Инициализацияinitialization)
	* [Константы(Constants)](#Константы(Constants))
...
* [Интерфейсы и другие типы](#Интерфейсы-и-другие-типы)
	...
	* [Общее(Generality)](#Общее(Generality))
	* [Интерфейсы и методы(функции)](#Интерфейсы-и-методы(функции))
* [Пустой идентификатор (The blank identifier **_**)](#Пустой-идентификатор-the-blank-identifier-_)
	* [Пустой дентификатор в множественном присваении (**_**)](#Пустой дентификатор-в-множественном-присваении-(**_**))
...
* [Вложение (Embedding)](#Вложение-embedding)
	* [огласованность, параллельная обработка, параллельное выполнение  (Concurrency)](#огласованность,-параллельная-обработка,-параллельное-выполнение--(Concurrency))
