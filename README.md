...
читает код на Go и выпускает исходный код со стандарным стилем отступов, вертикальном выравнивании, сохраняющая, и если необходимо, переформатирует комментарии.
...
<dl>
    ...
    <dt>Длина строки</dt>
    <dd>Go не имеет предела длины строки. Не беспокойтесь о длинных строках. Если строка кажется слишком длинной, прервите ее и добавьте дополнительный отступ (tab) на новой строке.</dd>
